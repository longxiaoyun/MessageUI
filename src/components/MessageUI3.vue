  ...
  <div id="message-container" v-drag>
    ...
    <section class="header-container">
       <div class="slider-toggle">
         <button class="tog-btn"  @click="toggleSlider">切换</button>
       </div>
...
<!--          <div  role="button" class="text-input" placeholder="Write a reply" style="color: rgb(86, 88, 103);float: left;width: 80%;" contenteditable="true"></div>-->
...
export default {
  ...
  data() {
    return {
      ...
      isCollapse: true,
      message: '',
      // message_container_background: 'rgba(0,0,0,1)'
      items: [
        {
          title: '机器人',
          needLogin: false,
  ...
  directives: {
    drag: {
      bind: (el, binding) => {
        ...
        // el.style.backgroundColor = this.message_container_background;
